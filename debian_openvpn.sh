...
if [ -e /etc/openvpn/server.conf ]; then
	...
	echo 'Selamat Datang Ke Short System OpenVPN Installer "Da[R]kCente[R]" installer'
	echo "Created by Fixxx Hitman Channel Team"
	echo ""
	...
	echo ""
	echo "Sebutkan nama untuk cert klien lOLZ juga Boleh"
